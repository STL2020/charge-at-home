...
# Der Port steckt in services/ocpp_port_service — dort ohne schwere
# Importe, damit auch Routen ihn lesen koennen, die websockets nicht
# brauchen.
from services.ocpp_port_service import ocpp_port
