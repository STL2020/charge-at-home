...
function _fahrzeugStatusKachelHtml(v, d, kont) {
  ...
  // Verriegelung: NUR anzeigen, wenn der Wert wirklich bekannt ist.
  // Zuvor wurde bei fehlendem Wert "Verriegelt" behauptet -- das Fahrzeug
  // des Nutzers sendet door.lock.status ueberhaupt nicht, die Anzeige war
  // also frei erfunden. Lieber gar kein Chip als eine falsche Aussage
  // ueber den Verschlusszustand eines Autos.
