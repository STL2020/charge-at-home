...
PROJECT_STATUS = [
    ...
    {"sprint": 9, "id": "S9-57", "modul": "Ladevorgaenge", "text": "Werkzeugleiste war weiterhin sichtbar schief: Zeitraum-Knoepfe und Feldfilter (Von/Bis/Wallbox/Quelle) lagen in EINER Reihe, obwohl die Feldgruppe wegen ihrer Beschriftungen deutlich hoeher ist -- keine Ausrichtungsvariante konnte das begradigen. Jetzt zwei ruhige Zeilen: oben Zeitraum-Knoepfe plus Aktionen rechtsbuendig, darunter die Feldfilter.", "status": "fertig", "view": "ladesessions"},
